...
const FooterBottom = () => {
    return (
        ...
        <div className="container mx-auto lg:px-12 flex flex-wrap flex-col items-center sm:flex-row">
            <p className="text-sm text-center sm:text-left"> &copy; {new Date().getFullYear()} ShopNest —
                <Link to="https://www.linkedin.com/in/arfat-begum-0b22221b2/" rel="noopener noreferrer" className="ml-1" target="_blank">@shantveereshvs. All Rights Reserved.</Link>
            </p>
